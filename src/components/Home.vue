<template>
  <div class="hero">
    <div align="center">
      <b-card
        title="Barbers"
        img-src="https://ak6.picdn.net/shutterstock/videos/14456296/thumb/1.jpg"
      ...
      >
        ...
        <b-button to="login" variant="primary">Book Appointment</b-button>
      </b-card>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget subscribe no-box">
                <h5 class="widget-title">BQUICK<span></span></h5>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              ...
              <div class="widget no-box">
                ...
                <p><a href="mailto:bquick.info@outlook.ie" title="glorythemes">bquick.info@outlook.ie</a></p>
                <ul class="social-footer2">
                  ...
                  <li class=""><a href="https://twitter.com" target="_blank" title="Twitter"><img alt="Twitter"
                                                                                                  width="30" height="30"
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <p>BQUICK © 2020. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
